...
### 1. マインドセット：AIを道具として使う

電卓が登場したとき、「暗算できなくなる」と批判がありました。Excelが普及したとき、「手計算の技術が失われる」と言われました。しかし今、電卓やExcelを使わない経理担当者はいません。

AIも同じです。「自分でやる」ことが美徳だった時代から、「AIと協働する」時代へ。抵抗感を捨て、まずは触ってみること。これが最初の備えです。

### 2. 情報の整理：AIは紙が読めない

AIは万能に見えますが、**紙の書類は読めません**。PDFやWordに変換されていても、スキャン画像のままでは中身を理解できません。

AIを業務に活かすには、情報が「AIに読める形」で整理されている必要があります。

- 会計データ：手書き帳簿 → 会計ソフト
- 顧客情報：名刺の束 → CRM/データベース
...
プログラミングができる必要はありません。しかし「AIに何ができるか」を理解し、「自分の業務のどこに使えるか」を考えられる人材は不可欠です。
...
*この資料もAIと一緒に書きました。構成を考え、文章を生成する作業をAIとの対話で進めています。*
